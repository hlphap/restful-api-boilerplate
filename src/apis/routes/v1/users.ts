...
router.put("/:userID", [checkJwt, checkRole(["ADMINISTRATOR", "STANDARD"], true), validate(updateUserSchema)], userControllers.updateUser);
router.delete("/:userID", [checkJwt, checkRole(["ADMINISTRATOR"], true), validate(deleteUserSchema)], userControllers.deleteUser);
